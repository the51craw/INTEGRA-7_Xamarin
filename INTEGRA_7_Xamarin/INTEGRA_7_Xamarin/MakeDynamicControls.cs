...
namespace Integra_7_Xamarin
{
    public sealed partial class UIHandler
    {
        ...
        private void AddPCMSynthToneCommonControls()
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_PCMSynthTone_PhraseNumber, cbEditTone_PCMSynthTone_PhraseOctaveShift })).Row);
            // Put Level with label on line 1:
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_ToneLevel, slEditTone_PCMSynthTone_ToneLevel }, new byte[] { 1, 2 })).Row);

            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_TonePan, slEditTone_PCMSynthTone_TonePan }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_PCMSynthTone_TonePriority, cbEditTone_PCMSynthTone_OctaveShift, cbEditTone_PCMSynthTone_StretchTuneDepth }, new byte[] { 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_CoarseTune, slEditTone_PCMSynthTone_CoarseTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_FineTune, slEditTone_PCMSynthTone_FineTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_PCMSynthTone_AnalogFeel, slEditTone_PCMSynthTone_AnalogFeel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_PCMSynthTone_CutoffOffset, slEditTone_PCMSynthTone_CutoffOffset }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMSynthTone_ResonanceOffset, slEditTone_PCMSynthTone_ResonanceOffset }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { tbEditTone_PCMSynthTone_AttackTimeOffset, slEditTone_PCMSynthTone_AttackTimeOffset }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_PCMSynthTone_ReleaseTimeOffset, slEditTone_PCMSynthTone_ReleaseTimeOffset }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(11, new View[] { tbEditTone_PCMSynthTone_VelocitySenseOffset, slEditTone_PCMSynthTone_VelocitySenseOffset }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(12, new View[] { cbEditTone_PCMSynthTone_MonoPoly, cbEditTone_PCMSynthTone_Legato, cbEditTone_PCMSynthTone_LegatoTrigger }, new byte[] { 1, 1, 1 })).Row);
        ...
        private void AddPCMSynthToneWaveControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_WaveGroupType, cbEditTone_PCMSynthTone_WaveGain }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_Wave_WaveNumberL, cbEditTone_PCMSynthTone_Wave_WaveNumberL }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_Wave_WaveNumberR, cbEditTone_PCMSynthTone_Wave_WaveNumberR }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_PCMSynthTone_Wave_WaveTempoSync, cbEditTone_PCMSynthTone_Wave_WaveFXMSwitch, cbEditTone_PCMSynthTone_FXMColor })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_pCMSynthTone_Wave_WaveFXMDepth, slEditTone_pCMSynthTone_Wave_WaveFXMDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthTonePMTControls(byte PMTIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_PCMSynthTone_Wave_PMTPartial1Switch, cbEditTone_PCMSynthTone_Wave_PMTPartial2Switch,
                cbEditTone_PCMSynthTone_Wave_PMTPartial3Switch, cbEditTone_PCMSynthTone_Wave_PMTPartial4Switch})).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_Partial, cbEditTone_PCMSynthTone_PMT_PMTVelocityControl, cbEditTone_PCMSynthTone_PMT_PMTControlSwitch }, new byte[] { 2, 4, 3 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { cbEditTone_PCMSynthTone_PMT_StructureType1_2, cbEditTone_PCMSynthTone_PMT_Booster1_2, }, new byte[] { 2, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_PCMSynthTone_PMT_StructureType3_4, cbEditTone_PCMSynthTone_PMT_Booster3_4 }, new byte[] { 2, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_PMT_PMTKeyboardFadeWidthUpper, slEditTone_PCMSynthTone_PMT_PMTKeyboardFadeWidthUpper }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_PMT_PMTKeyboardRangeUpper, slEditTone_PCMSynthTone_PMT_PMTKeyboardRangeUpper }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_PCMSynthTone_PMT_PMTKeyboardRangeLower, slEditTone_PCMSynthTone_PMT_PMTKeyboardRangeLower }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_PCMSynthTone_PMT_PMTKeyboardFadeWidthLower, slEditTone_PCMSynthTone_PMT_PMTKeyboardFadeWidthLower }, new byte[] { 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMSynthTone_PMT_PMTVelocityFadeWidthUpper, slEditTone_PCMSynthTone_PMT_PMTVelocityFadeWidthUpper })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { tbEditTone_PCMSynthTone_PMT_PMTVelocityRangeUpper, slEditTone_PCMSynthTone_PMT_PMTVelocityRangeUpper })).Row);
        ...
        private void AddPCMSynthTonePitchControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_Pitch_PartialCoarseTune, slEditTone_PCMSynthTone_Pitch_PartialCoarseTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_Pitch_PartialFineTune, slEditTone_PCMSynthTone_Pitch_PartialFineTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_PCMSynthTone_Pitch_PartialRandomPitchDepth })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_Pitch_WavePitchKeyfollow, slEditTone_PCMSynthTone_Pitch_WavePitchKeyfollow }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthTonePitchEnvControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch
                , cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch})).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvDepth, slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvVelocitySens, slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime1VelocitySens, slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime1VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime4VelocitySens, slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime4VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTimeKeyfollow, slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTimeKeyfollow }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(6 + i), new View[] { tbEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime[i], slEditTone_PCMSynthTone_Pitchenvelope_PitchEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 5; i++)
            {
        ...
        private void AddPCMSynthToneTVFControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch
                , cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch})).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_TVF_TVFFilterType })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_TVF_TVFCutoffFrequency, slEditTone_PCMSynthTone_TVF_TVFCutoffFrequency }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_TVF_TVFResonance, slEditTone_PCMSynthTone_TVF_TVFResonance }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_TVF_TVFCutoffKeyfollow, slEditTone_PCMSynthTone_TVF_TVFCutoffKeyfollow }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { cbEditTone_PCMSynthTone_TVF_TVFCutoffVelocityCurve })).Row);
        ...
        private void AddPCMSynthToneTVFEnvControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvDepth, slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvVelocitySens, slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime1VelocitySens, slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime1VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime4VelocitySens, slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime4VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTimeKeyfollow, slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTimeKeyfollow }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(6 + i), new View[] { tbEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime[i], slEditTone_PCMSynthTone_TVFEnvelope_TVFEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 5; i++)
            {
        ...
        private void AddPCMSynthToneTVAControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_TVA_PartialOutputLevel, slEditTone_PCMSynthTone_TVA_PartialOutputLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { cbEditTone_PCMSynthTone_TVA_TVALevelVelocityCurve })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_TVA_TVALevelVelocitySens, slEditTone_PCMSynthTone_TVA_TVALevelVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMSynthTone_TVA_BiasLevel, slEditTone_PCMSynthTone_TVA_BiasLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_TVA_BiasPosition, slEditTone_PCMSynthTone_TVA_BiasPosition }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_PCMSynthTone_TVA_BiasDirection })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_PCMSynthTone_TVA_PartialPan, slEditTone_PCMSynthTone_TVA_PartialPan }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMSynthTone_TVA_PartialPanKeyfollow, slEditTone_PCMSynthTone_TVA_PartialPanKeyfollow }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthToneTVAEnvControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch,
            cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch}, new byte[] { 1, 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime1VelocitySens, slEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime1VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime4VelocitySens, slEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime4VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTimeKeyfollow, slEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTimeKeyfollow }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(4 + i), new View[] { tbEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime[i], slEditTone_PCMSynthTone_TVAEnvelope_TVAEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 3; i++)
            {
        ...
        private void AddPCMSynthToneOutputControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch,
                cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch}, new byte[] { 1, 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMSynthTone_Output_PartialOutputLevel, slEditTone_PCMSynthTone_Output_PartialOutputLevel }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthToneLFO01Controls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch,
                cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch}, new byte[] { 1, 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_LFO1_LFO1Waveform })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_LFO1_LFORate, slEditTone_PCMSynthTone_LFO1_LFORate }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_LFO1_LFORateDetune, slEditTone_PCMSynthTone_LFO1_LFORateDetune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_PCMSynthTone_LFO1_LFOOffset })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_LFO1_LFODelayTime, slEditTone_PCMSynthTone_LFO1_LFODelayTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_PCMSynthTone_LFO1_LFODelayTimeKeyfollow, slEditTone_PCMSynthTone_LFO1_LFODelayTimeKeyfollow }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { cbEditTone_PCMSynthTone_LFO1_LFOFadeMode })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMSynthTone_LFO1_LFOFadeTime, slEditTone_PCMSynthTone_LFO1_LFOFadeTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { cbEditTone_PCMSynthTone_LFO1_LFOKeyTrigger })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_PCMSynthTone_LFO1_LFOPitchDepth, slEditTone_PCMSynthTone_LFO1_LFOPitchDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(11, new View[] { tbEditTone_PCMSynthTone_LFO1_LFOTVFDepth, slEditTone_PCMSynthTone_LFO1_LFOTVFDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthToneLFO02Controls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch,
                cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch}, new byte[] { 1, 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_LFO2_LFO2Waveform })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMSynthTone_LFO2_LFORate, slEditTone_PCMSynthTone_LFO2_LFORate }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMSynthTone_LFO2_LFORateDetune, slEditTone_PCMSynthTone_LFO2_LFORateDetune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_PCMSynthTone_LFO2_LFOOffset })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMSynthTone_LFO2_LFODelayTime, slEditTone_PCMSynthTone_LFO2_LFODelayTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_PCMSynthTone_LFO2_LFODelayTimeKeyfollow, slEditTone_PCMSynthTone_LFO2_LFODelayTimeKeyfollow }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { cbEditTone_PCMSynthTone_LFO2_LFOFadeMode })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMSynthTone_LFO2_LFOFadeTime, slEditTone_PCMSynthTone_LFO2_LFOFadeTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { cbEditTone_PCMSynthTone_LFO2_LFOKeyTrigger })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_PCMSynthTone_LFO2_LFOPitchDepth, slEditTone_PCMSynthTone_LFO2_LFOPitchDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(11, new View[] { tbEditTone_PCMSynthTone_LFO2_LFOTVFDepth, slEditTone_PCMSynthTone_LFO2_LFOTVFDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMSynthToneControlControls(byte Partial)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMSynthTone_Pitch_PitchPartial1Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial2Switch,
                cbEditTone_PCMSynthTone_Pitch_PitchPartial3Switch, cbEditTone_PCMSynthTone_Pitch_PitchPartial4Switch}, new byte[] { 1, 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMSynthTone_Control_PartialEnvMode })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { cbEditTone_PCMSynthTone_Control_PartialReceiveBender })).Row);
        ...
        private void AddPCMSynthToneMFXControlControls()
        {
            ...
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(0 + 3 * i), new View[] { cbEditTone_PCMSynthTone_MFXControl_MFXControlSource[i] })).Row);
                ControlsGrid.Children.Add((new GridRow((byte)(1 + 3 * i), new View[] { cbEditTone_PCMSynthTone_MFXControl_MFXControlAssign[i] })).Row);
                ControlsGrid.Children.Add((new GridRow((byte)(2 + 3 * i), new View[] { tbEditTone_PCMSynthTone_MFXControl_MFXControlSens[i], slEditTone_PCMSynthTone_MFXControl_MFXControlSens[i] }, new byte[] { 1, 2 })).Row);
            }
        ...
        private void AddPCMDrumKitWaveControls() //byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMDrumKit_Wave_WMTWaveGroupType })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_Wave_WaveNumberL, cbEditTone_PCMDrumKit_Wave_WMTWaveNumberL })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_Wave_WaveNumberR, cbEditTone_PCMDrumKit_Wave_WMTWaveNumberR })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_PCMDrumKit_Wave_WaveGain })).Row);
            ...
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_PCMDrumKit_Wave_WMTWaveFXMColor })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_PCMDrumKit_Wave_WMTWaveFXMDepth, slEditTone_PCMDrumKit_Wave_WMTWaveFXMDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_PCMDrumKit_Wave_WMTWaveCoarseTune, slEditTone_PCMDrumKit_Wave_WMTWaveCoarseTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { tbEditTone_PCMDrumKit_Wave_WMTWaveFineTune, slEditTone_PCMDrumKit_Wave_WMTWaveFineTune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_PCMDrumKit_Wave_WMTWaveLevel, slEditTone_PCMDrumKit_Wave_WMTWaveLevel }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMDrumKitWMTControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] {  cbEditTone_PCMDrumKit_Partial1Switch,
                cbEditTone_PCMDrumKit_Partial2Switch, cbEditTone_PCMDrumKit_Partial3Switch,
                cbEditTone_PCMDrumKit_Partial4Switch }, new byte[] { 1, 1, 1, 1 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMDrumKit_WMT_WMTVelocityControl })).Row);
        ...
        private void AddPCMDrumKitPitchEnvControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { tbEditTone_PCMDrumKit_Pitch_PitchEnvDepth, slEditTone_PCMDrumKit_Pitch_PitchEnvDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMDrumKit_Pitch_PitchEnvVelocitySens, slEditTone_PCMDrumKit_Pitch_PitchEnvVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMDrumKit_Pitch_PitchEnvTime1VelocitySens, slEditTone_PCMDrumKit_Pitch_PitchEnvTime1VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMDrumKit_Pitch_PitchEnvTime4VelocitySens, slEditTone_PCMDrumKit_Pitch_PitchEnvTime4VelocitySens }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(4 + i), new View[] { tbEditTone_PCMDrumKit_Pitch_PitchEnvTime[i], slEditTone_PCMDrumKit_Pitch_PitchEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 5; i++)
            {
        ...
        private void AddPCMDrumKitTVFControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_PCMDrumKit_TVF_TVFFilterType })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMDrumKit_TVF_TVFCutoffFrequency, slEditTone_PCMDrumKit_TVF_TVFCutoffFrequency }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMDrumKit_TVF_TVFResonance, slEditTone_PCMDrumKit_TVF_TVFResonance }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_PCMDrumKit_TVF_TVFCutoffVelocityCurve })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMDrumKit_TVF_TVFCutoffVelocitySens, slEditTone_PCMDrumKit_TVF_TVFCutoffVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_PCMDrumKit_TVF_TVFResonanceVelocitySens, slEditTone_PCMDrumKit_TVF_TVFResonanceVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_PCMDrumKit_TVF_TVFEnvVelocityCurveType })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_PCMDrumKit_TVF_TVFEnvVelocitySens, slEditTone_PCMDrumKit_TVF_TVFEnvVelocitySens }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMDrumKitTVFEnvControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { tbEditTone_PCMDrumKit_TVFenv_TVFEnvDepth, slEditTone_PCMDrumKit_TVFenv_TVFEnvDepth }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(1 + i), new View[] { tbEditTone_PCMDrumKit_TVFenv_TVFEnvTime[i], slEditTone_PCMDrumKit_TVFenv_TVFEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 5; i++)
            {
        ...
        private void AddPCMDrumKitTVAControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { tbEditTone_PCMDrumKit_TVA_PartialLevel, slEditTone_PCMDrumKit_TVA_PartialLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_PCMDrumKit_TVA_TVALevelVelocityCurve })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_PCMDrumKit_TVA_TVALevelVelocitySens, slEditTone_PCMDrumKit_TVA_TVALevelVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_PCMDrumKit_TVA_PartialPan, slEditTone_PCMDrumKit_TVA_PartialPan }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_PCMDrumKit_TVA_PartialRandomPanDepth, slEditTone_PCMDrumKit_TVA_PartialRandomPanDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMDrumKitTVAEnvControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { tbEditTone_PCMDrumKit_TVA_TVAEnvTime1VelocitySens, slEditTone_PCMDrumKit_TVA_TVAEnvTime1VelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMDrumKit_TVA_TVAEnvTime4VelocitySens, slEditTone_PCMDrumKit_TVA_TVAEnvTime4VelocitySens }, new byte[] { 1, 2 })).Row);
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(2 + i), new View[] { tbEditTone_PCMDrumKit_TVA_TVAEnvTime[i], slEditTone_PCMDrumKit_TVA_TVAEnvTime[i] }, new byte[] { 1, 2 })).Row);
            }
            for (byte i = 0; i < 3; i++)
            {
        ...
        private void AddPCMDrumKitOutputControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_PCMDrumKit_TVA_PartialOutputAssign })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMDrumKit_TVA_PartialOutputLevel, slEditTone_PCMDrumKit_TVA_PartialOutputLevel }, new byte[] { 1, 2 })).Row);
        ...
        private void AddPCMDrumKitEqualizerControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_PCMDrumKit_Equalizer_FrequencyHeader })).Row);
        ...
        private void AddPCMDrumKitMFXControlControls()
        {
            ...
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(0 + 3 * i), new View[] { cbEditTone_PCMDrumKit_MFXcontrol_MFXControlSource[i] })).Row);
                ControlsGrid.Children.Add((new GridRow((byte)(1 + 3 * i), new View[] { cbEditTone_PCMDrumKit_MFXcontrol_MFXControlAssign[i] })).Row);
        ...
        private void AddSupernaturalAcousticToneInstrumentParametersControls()
        {
            ...
            if (superNaturalAcousticInstrumentList.ParameterMask[index][((controlsIndex++) - 2)] > 0)
            {
                ...
                // Put in row
                ControlsGrid.Children.Add((new GridRow(row++, new View[] { tbEditTone_SuperNATURALAcousticTone_Instrument_MalletHardnessCC16, slEditTone_SuperNATURALAcousticTone_Instrument_MalletHardnessCC16 }, new byte[] { 1, 2 })).Row);
            ...
            if (commonState.currentTone.VariationIndex > -1)
            {
                ...
                if (superNATURALAcousticToneVariation != null)
                {
                    ...
                    // Put in row
                    ControlsGrid.Children.Add((new GridRow(row++, new View[] { cbEditTone_SuperNATURALAcousticTone_Instrument_InstVariation })).Row);
        ...
        private void AddSupernaturalSynthToneCommonControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_SuperNATURALSynthTone_Common_PhraseNumber })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALSynthTone_Common_PhraseOctaveShift })).Row);
            ...
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_superNATURALSynthTone_Common_RINGSwitch })).Row);
            ...
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_superNATURALSynthTone_Common_UnisonSwitch })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { cbEditTone_superNATURALSynthTone_Common_UnisonSize })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { cbEditTone_superNATURALSynthTone_Common_MonoPoly })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { cbEditTone_superNATURALSynthTone_Common_LegatoSwitch })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { cbEditTone_superNATURALSynthTone_Common_PortamentoSwitch })).Row);
        ...
        private void AddSupernaturalSynthToneOscControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALSynthTone_Osc_WaveShape })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { cbEditTone_superNATURALSynthTone_Osc_WaveVariation })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_superNATURALSynthTone_Osc_WaveNumber })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_superNATURALSynthTone_Osc_WaveGain })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_Osc_PulseWidthModDepth, slEditTone_superNATURALSynthTone_Osc_PulseWidthModDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSupernaturalSynthTonePitchControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_superNATURALSynthTone_Pitch_OSCPitch, slEditTone_superNATURALSynthTone_Pitch_OSCPitch }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALSynthTone_Pitch_OSCDetune, slEditTone_superNATURALSynthTone_Pitch_OSCDetune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_superNATURALSynthTone_Pitch_PitchEnvAttackTime, slEditTone_superNATURALSynthTone_Pitch_PitchEnvAttackTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_superNATURALSynthTone_Pitch_OSCPitchEnvDecay, slEditTone_superNATURALSynthTone_Pitch_OSCPitchEnvDecay }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_Pitch_OSCPitchEnvDepth, slEditTone_superNATURALSynthTone_Pitch_OSCPitchEnvDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_superNATURALSynthTone_Pitch_OSCOctaveShift })).Row);
        ...
        private void AddSupernaturalSynthToneFilterControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALSynthTone_Pitch_FILTERMode })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { cbEditTone_superNATURALSynthTone_Pitch_FILTERSlope })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTERCutoff, slEditTone_superNATURALSynthTone_Pitch_FILTERCutoff }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTERCutoffKeyfollow, slEditTone_superNATURALSynthTone_Pitch_FILTERCutoffKeyfollow }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTEREnvVelocitySens, slEditTone_superNATURALSynthTone_Pitch_FILTEREnvVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTERResonance, slEditTone_superNATURALSynthTone_Pitch_FILTERResonance }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTEREnvAttackTime, slEditTone_superNATURALSynthTone_Pitch_FILTEREnvAttackTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTEREnvDecayTime, slEditTone_superNATURALSynthTone_Pitch_FILTEREnvDecayTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTEREnvSustainLevel, slEditTone_superNATURALSynthTone_Pitch_FILTEREnvSustainLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_superNATURALSynthTone_Pitch_FILTEREnvReleaseTime, slEditTone_superNATURALSynthTone_Pitch_FILTEREnvReleaseTime }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSupernaturalSynthToneAMPControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPLevel, slEditTone_superNATURALSynthTone_Amp_AMPLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPLevelVelocitySens, slEditTone_superNATURALSynthTone_Amp_AMPLevelVelocitySens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPPan, slEditTone_superNATURALSynthTone_Amp_AMPPan }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPLevelKeyfollow, slEditTone_superNATURALSynthTone_Amp_AMPLevelKeyfollow }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPEnvAttackTime, slEditTone_superNATURALSynthTone_Amp_AMPEnvAttackTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_superNATURALSynthTone_Amp_AMPEnvDecayTime, slEditTone_superNATURALSynthTone_Amp_AMPEnvDecayTime }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSupernaturalSynthToneLFOControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALSynthTone_LFO_LFOShape })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALSynthTone_LFO_LFORate, slEditTone_superNATURALSynthTone_LFO_LFORate }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_superNATURALSynthTone_LFO_LFOTempoSyncSwitch })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_superNATURALSynthTone_LFO_LFOTempoSyncNote })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_LFO_LFOFadeTime, slEditTone_superNATURALSynthTone_LFO_LFOFadeTime }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { cbEditTone_superNATURALSynthTone_LFO_LFOKeyTrigger })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_superNATURALSynthTone_LFO_LFOPitchDepth, slEditTone_superNATURALSynthTone_LFO_LFOPitchDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_superNATURALSynthTone_LFO_LFOFilterDepth, slEditTone_superNATURALSynthTone_LFO_LFOFilterDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSupernaturalSynthToneModLFOControls(byte SelectedIndex)
        {
            ...
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALSynthTone_LFO_ModulationLFOShape })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALSynthTone_LFO_ModulationLFORate, slEditTone_superNATURALSynthTone_LFO_ModulationLFORate }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { cbEditTone_superNATURALSynthTone_LFO_ModulationLFOTempoSyncSwitch })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { cbEditTone_superNATURALSynthTone_LFO_ModulationLFOTempoSyncNote })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALSynthTone_LFO_ModulationLFOPitchDepth, slEditTone_superNATURALSynthTone_LFO_ModulationLFOPitchDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_superNATURALSynthTone_LFO_ModulationLFOFilterDepth, slEditTone_superNATURALSynthTone_LFO_ModulationLFOFilterDepth }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_superNATURALSynthTone_LFO_ModulationLFOAmpDepth, slEditTone_superNATURALSynthTone_LFO_ModulationLFOAmpDepth }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSupernaturalSynthToneMiscControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { tbEditTone_superNATURALSynthTone_Misc_AttackTimeIntervalSens, slEditTone_superNATURALSynthTone_Misc_AttackTimeIntervalSens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { tbEditTone_superNATURALSynthTone_Misc_ReleaseTimeIntervalSens, slEditTone_superNATURALSynthTone_Misc_ReleaseTimeIntervalSens }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALSynthTone_Misc_PortamentoTimeIntervalSens, slEditTone_superNATURALSynthTone_Misc_PortamentoTimeIntervalSens }, new byte[] { 1, 2 })).Row);
        ...
        private void AddSuperNaturalSynthToneMFXControlControls()
        {
            ...
            for (byte i = 0; i < 4; i++)
            {
                ControlsGrid.Children.Add((new GridRow((byte)(0 + 3 * i), new View[] { cbEditTone_CommonMFX_MFXControl_MFXControlSource[i] })).Row);
                ControlsGrid.Children.Add((new GridRow((byte)(1 + 3 * i), new View[] { cbEditTone_CommonMFX_MFXControl_MFXControlAssign[i] })).Row);
                ControlsGrid.Children.Add((new GridRow((byte)(2 + 3 * i), new View[] { tbEditTone_CommonMFX_MFXControl_MFXControlSens[i], slEditTone_CommonMFX_MFXControl_MFXControlSens[i] }, new byte[] { 1, 2 })).Row);
            }
        ...
        private void AddSupernaturalDrumKitDruminstrumentControls(byte SelectedIndex)
        {
            ...
            // Put in rows
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_superNATURALDrumKit_Druminstrument_BankNumber })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALDrumKit_Druminstrument_InstNumber_INT })).Row);
            ControlsGrid.Children.Add((new GridRow(1, new View[] { cbEditTone_superNATURALDrumKit_Druminstrument_InstNumber_ExSN6 })).Row);
            ControlsGrid.Children.Add((new GridRow(2, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Level, slEditTone_superNATURALDrumKit_Druminstrument_Level }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(3, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Pan, slEditTone_superNATURALDrumKit_Druminstrument_Pan }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(4, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_ChorusSendLevel, slEditTone_superNATURALDrumKit_Druminstrument_ChorusSendLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(5, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_ReverbSendLevel, slEditTone_superNATURALDrumKit_Druminstrument_ReverbSendLevel }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(6, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Tune, slEditTone_superNATURALDrumKit_Druminstrument_Tune }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(7, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Attack, slEditTone_superNATURALDrumKit_Druminstrument_Attack }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(8, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Decay, slEditTone_superNATURALDrumKit_Druminstrument_Decay }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(9, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_Brilliance, slEditTone_superNATURALDrumKit_Druminstrument_Brilliance }, new byte[] { 1, 2 })).Row);
            ControlsGrid.Children.Add((new GridRow(10, new View[] { tbEditTone_superNATURALDrumKit_Druminstrument_DynamicRange, slEditTone_superNATURALDrumKit_Druminstrument_DynamicRange }, new byte[] { 1, 2 })).Row);
        ...
        private void AddMFXControls()
        {
            ...
            ControlsGrid.Children.Add((new GridRow(0, new View[] { cbEditTone_MFXType })).Row);
                ...
                for (byte parameterNumber = 0; parameterNumber < numberedParametersContent.ParameterNames[commonMFX.MFXType + currentMFXTypeOffset].Length; parameterNumber++)
                {
                    switch (numberedParametersContent.ParameterTypes[commonMFX.MFXType + currentMFXTypeOffset][parameterNumber])
                    {
                        ...
                        case PARAMETER_TYPE.COMBOBOX_MS_AND_NOTE_LENGTHS:
                            ...
                            break;
                        case PARAMETER_TYPE.CHECKBOX:
                            ControlsGrid.Children.Add((new GridRow((byte)(parameterNumber + 1 - rowOffset), new View[] { dynamicCheckboxes[checkboxIndex++] }, new byte[] { 1 })).Row);
                            break;
                        case PARAMETER_TYPE.CHECKBOX_1:
                        case PARAMETER_TYPE.CHECKBOX_2:
                        case PARAMETER_TYPE.CHECKBOX_3:
